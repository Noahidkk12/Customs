...
local CONFIG_NAME, lastSaveTime, savedAnimate = "VaultsHubConfig", 0, nil
local floatButtons = {}
...
HUDTitle.Text = "VaultsHub" HUDTitle.TextColor3 = THEME.Accent
...
Title.Text = "VaultsHub" Title.TextColor3 = THEME.Accent Title.Font = Enum.Font.GothamBold
